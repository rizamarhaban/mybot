...
namespace Microsoft.Bot.Connector
{
    ...
    {
        public static AuthenticationBuilder AddBotAuthentication(this AuthenticationBuilder builder, string microsoftAppId = default(string), string microsoftAppPassword = default(string))
